    ...
    return (
      <div className="flex flex-col items-center justify-center text-center bg-[#1e293b] p-4 ml-[250px]">
        ...
        <p className="pl-10 text-xl tracking-wider font-inter">
          ...
          I love to take challenge and  deliver it within schedule. My
          expertise on Reactjs, Nextjs, Threejs .NET, Typescript, Node.js, Python, Tailwind ,MaterialUI, Chakra UI, etc. I have well experienced to convert
        ...
        <div className="pt-20">
          ...
          <p className="uppercase tracking-widest text-[#5651e5]">
            {" "}
            or go to my Github Profile For more..!
          </p>
